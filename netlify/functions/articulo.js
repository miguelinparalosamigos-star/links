...
const CATALOGO_LIBROS = [
  ...
  { id: 'habitos-atomicos', titulo: 'Hábitos atómicos', emoji: '📖', url: 'https://www.amazon.es/s?k=h%C3%A1bitos+at%C3%B3micos+james+clear&tag=conciencia07-21', temas: ['habitos', 'trabajo'], palabrasClave: ['hábito', 'hábitos', 'habito', 'habitos', 'rutina', 'rutinas', 'costumbre', 'cambiar', 'cambio', 'disciplina', 'constancia', 'motivación', 'productividad', 'procrastinación', 'comportamiento', 'conducta'] },
  { id: 'sentirse-bien', titulo: 'Sentirse bien', emoji: '📖', url: 'https://www.amazon.es/s?k=sentirse+bien+david+burns&tag=conciencia07-21', temas: ['estado-animo', 'ansiedad'], palabrasClave: ['depresión', 'depresion', 'tristeza', 'ánimo', 'animo', 'desánimo', 'desanimo', 'autoestima', 'pensamientos negativos', 'autocrítica', 'autocritica', 'culpa', 'rumiación', 'rumiacion', 'desesperanza', 'melancolía'] },
  { id: 'cuerpo-lleva-cuenta', titulo: 'El cuerpo lleva la cuenta', emoji: '📖', url: 'https://www.amazon.es/s?k=el+cuerpo+lleva+la+cuenta+bessel+van+der+kolk&tag=conciencia07-21', temas: ['estres-trauma'], palabrasClave: ['trauma', 'traumático', 'traumatico', 'tept', 'estrés postraumático', 'estres postraumatico', 'abuso', 'maltrato', 'violencia', 'duelo', 'disociación', 'disociacion', 'trauma psicológico', 'guerra', 'conflicto'] },
  { id: 'cosas-buenas', titulo: 'Cómo hacer que te pasen cosas buenas', emoji: '📖', url: 'https://www.amazon.es/s?k=c%C3%B3mo+hacer+que+te+pasen+cosas+buenas+marian+rojas&tag=conciencia07-21', temas: ['bienestar', 'ansiedad', 'estres-trauma'], palabrasClave: ['cortisol', 'estrés', 'estres', 'ansiedad', 'preocupación', 'preocupacion', 'emociones', 'emocional', 'bienestar', 'felicidad', 'cerebro', 'optimismo', 'miedo'] },
  { id: 'no-amargarse', titulo: 'El arte de no amargarse la vida', emoji: '📖', url: 'https://www.amazon.es/s?k=el+arte+de+no+amargarse+la+vida+santandreu&tag=conciencia07-21', temas: ['bienestar', 'ansiedad'], palabrasClave: ['ansiedad', 'preocupación', 'preocupacion', 'felicidad', 'pensamientos', 'autoexigencia', 'perfeccionismo', 'malestar', 'exigencia', 'catastrofismo', 'fortaleza'] },
  { id: 'se-amable', titulo: 'Sé amable contigo mismo', emoji: '📖', url: 'https://www.amazon.es/s?k=s%C3%A9+amable+contigo+mismo+kristin+neff&tag=conciencia07-21', temas: ['personalidad', 'bienestar'], palabrasClave: ['autocompasión', 'autocompasion', 'autocrítica', 'autocritica', 'autoestima', 'vergüenza', 'verguenza', 'culpa', 'perfeccionismo', 'amabilidad', 'compasión', 'autoexigencia'] },
  { id: 'por-que-dormimos', titulo: 'Por qué dormimos', emoji: '📖', url: 'https://www.amazon.es/s?k=por+qu%C3%A9+dormimos+matthew+walker&tag=conciencia07-21', temas: ['sueno'], palabrasClave: ['sueño', 'sueno', 'dormir', 'insomnio', 'descanso', 'rem', 'circadiano', 'siesta', 'melatonina', 'despertar', 'soñar', 'pesadilla'] },
  { id: 'cinco-lenguajes-amor', titulo: 'Los cinco lenguajes del amor', emoji: '📖', url: 'https://www.amazon.es/s?k=los+cinco+lenguajes+del+amor+gary+chapman&tag=conciencia07-21', temas: ['pareja', 'social'], palabrasClave: ['pareja', 'amor', 'relación', 'relaciones', 'matrimonio', 'afecto', 'comunicación', 'comunicacion', 'convivencia', 'cariño', 'carino'] },
  { id: 'centrate-deep-work', titulo: 'Céntrate (Deep Work)', emoji: '📖', url: 'https://www.amazon.es/s?k=c%C3%A9ntrate+deep+work+cal+newport&tag=conciencia07-21', temas: ['atencion', 'trabajo'], palabrasClave: ['concentración', 'concentracion', 'atención', 'atencion', 'foco', 'distracción', 'distraccion', 'productividad', 'procrastinación', 'móvil', 'movil', 'multitarea', 'rendimiento'] },
];
